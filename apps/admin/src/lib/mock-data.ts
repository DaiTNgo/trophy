...
export const shippingProfileOptions = ["Default Shipping Profile", "Bulky Freight", "Express Small Parcel"];
export const salesChannelOptions = ["Default Sales Channel", "Retail Pop-up", "Wholesale"];
