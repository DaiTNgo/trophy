...
4. Define `Variants` tab behavior as a variant-row editor for title, SKU, inventory quantity, optional backorder behavior, and prices rather than a preview-card summary.
...
6. Update the mock-first create contract so option definitions and generated variant rows follow the Medusa-thin workflow without shipping-profile, sales-channel, or inventory-kit fields.
